...
import { createSignal, createStore, useSignal, useStore, createComputed } from 'react-rx-signals';
...
function UserProfile() {
  ...
  return (
    <div>
      ...
      <button onClick={() => setUser(prev => ({ ...prev, name: 'Jane Doe' }))}>
        Change Name
      </button>
    </div>
  );
...
const userSummary$ = createComputed(user$, (user) => 
